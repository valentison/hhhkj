...
<link href="/Public/Admin/Css/login_css.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/Public/Admin/Js/jquery/jquery-1.7.1.js"></script>
<script type="text/javascript">
	$(document).ready(function(){
		$("#login_sub").click(function(){
			$("#submitForm").attr("action", "<?php echo U('Admin/User/login');?>").submit();
		});
	});
			...
			<div id="login_box">
				<div id="login_form">
					<form id="submitForm" action="" method="post">
						...
						<div>
							 用户名：<input type="text" name="user_name" class="username" id="name">
						</div>
						<div>

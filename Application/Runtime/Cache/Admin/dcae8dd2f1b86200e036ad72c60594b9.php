        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="title" value="<?php echo ($info["title"]); ?>" placeholder="网站标题">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="name" value="<?php echo ($info["name"]); ?>" placeholder="公司名称">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="manager" value="<?php echo ($info["manager"]); ?>" placeholder="主管">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="tel" value="<?php echo ($info["tel"]); ?>" placeholder="电话">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="fax" value="<?php echo ($info["fax"]); ?>" placeholder="传真">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="qq" value="<?php echo ($info["qq"]); ?>" placeholder="QQ">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="zipcode" value="<?php echo ($info["zipcode"]); ?>" placeholder="邮编">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-prepend">
                    ...
                    <input type="text" name="address" value="<?php echo ($info["address"]); ?>" placeholder="厂址">
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <textarea style="width:24%" name="introduce" rows="4" placeholder="公司简介"><?php echo ($info["introduce"]); ?></textarea>
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
